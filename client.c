...
void start_ftp_client()
{
    ...
    while (1) {
        ...
        else if(strncmp(cmd, "port ", 5) == 0 && login_flag == 0)
        {
            cmd_port();
        }
        else if(strncmp(cmd, "pasv ", 5) == 0 && login_flag == 0)
        {
            cmd_pasv();
        }
        ...
        else if(strncmp(cmd, "syst ", 5) == 0 && login_flag == 0)
        {
            cmd_syst();
        }
        else if(strncmp(cmd, "type ", 5) == 0 && login_flag == 0)
        {
            cmd_type();
        }
        else if(strncmp(cmd, "quit ", 5) == 0 && login_flag == 0)
        {
            cmd_quit();
        }
        else if(strncmp(cmd, "abor ", 5) == 0 && login_flag == 0)
        {
            cmd_abor();
        }
